...
@kwdef mutable struct NeuralODEThermalNetworkROMTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :NeuralODEThermalNetworkROMTransient
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = CFDReducedOrderModeling.TestNeuralODEThermalNetworkROM(; name=:TestNeuralODEThermalNetworkROM)
end

function DyadInterface.run_analysis(spec::NeuralODEThermalNetworkROMTransientSpec)
...
NeuralODEThermalNetworkROMTransient(;kwargs...) = run_analysis(NeuralODEThermalNetworkROMTransientSpec(;kwargs...))
export NeuralODEThermalNetworkROMTransient, NeuralODEThermalNetworkROMTransientSpec
export NeuralODEThermalNetworkROMTransientSpec, NeuralODEThermalNetworkROMTransient

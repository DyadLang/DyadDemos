...
@kwdef mutable struct PODDMDcROMTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :PODDMDcROMTransient
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = CFDReducedOrderModeling.TestPODDMDcROM(; name=:TestPODDMDcROM)
end

function DyadInterface.run_analysis(spec::PODDMDcROMTransientSpec)
...
PODDMDcROMTransient(;kwargs...) = run_analysis(PODDMDcROMTransientSpec(;kwargs...))
export PODDMDcROMTransient, PODDMDcROMTransientSpec
export PODDMDcROMTransientSpec, PODDMDcROMTransient

...
include("CFDTrainingAnalysis_definition.jl")
include("CFDValidationAnalysis_definition.jl")
include("HighFidelityOilPassage_definition.jl")
include("NeuralODEThermalNetworkROMTransient_definition.jl")
include("NeuralODEThermalNetworkROM_definition.jl")
include("PODDMDcROMTransient_definition.jl")
include("PODDMDcROM_definition.jl")
include("RampSource_definition.jl")
include("SVDThermalNetworkROMTransient_definition.jl")
include("SVDThermalNetworkROM_definition.jl")
include("StepSineSource_definition.jl")
include("TestCFDTraining_definition.jl")
include("TestCFDValidation_definition.jl")
include("TestNeuralODEThermalNetworkROM_definition.jl")
include("TestPODDMDcROM_definition.jl")
include("TestSVDThermalNetworkROM_definition.jl")
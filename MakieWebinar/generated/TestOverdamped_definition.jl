...
@doc Markdown.doc"""
   TestOverdamped(; name)
"""
@component function TestOverdamped(; name = nothing, kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = TestOverdamped()
  """))
  ...
  push!(__systems, @named circuit = MakieWebinar.TunableRLCResonance(; R=Float64(200.0), L=0.001, C=0.000001, V_init=Float64(10.0), circuit_overrides...))

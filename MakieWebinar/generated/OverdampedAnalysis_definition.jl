...
@kwdef mutable struct OverdampedAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :OverdampedAnalysis
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestOverdamped(; name=:TestOverdamped)
end

function DyadInterface.run_analysis(spec::OverdampedAnalysisSpec)
...
OverdampedAnalysis(;kwargs...) = run_analysis(OverdampedAnalysisSpec(;kwargs...))
export OverdampedAnalysis, OverdampedAnalysisSpec
export OverdampedAnalysisSpec, OverdampedAnalysis

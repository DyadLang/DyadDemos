...
@kwdef mutable struct TestReactionGrowthTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestReactionGrowthTransient
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestReactionGrowth5x5(; name=:TestReactionGrowth5x5)
end

function DyadInterface.run_analysis(spec::TestReactionGrowthTransientSpec)
...
TestReactionGrowthTransient(;kwargs...) = run_analysis(TestReactionGrowthTransientSpec(;kwargs...))
export TestReactionGrowthTransient, TestReactionGrowthTransientSpec
export TestReactionGrowthTransientSpec, TestReactionGrowthTransient

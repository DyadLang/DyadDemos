...
@kwdef mutable struct FastChargeAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :FastChargeAnalysis
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestFastCharge(; name=:TestFastCharge)
end

function DyadInterface.run_analysis(spec::FastChargeAnalysisSpec)
...
FastChargeAnalysis(;kwargs...) = run_analysis(FastChargeAnalysisSpec(;kwargs...))
export FastChargeAnalysis, FastChargeAnalysisSpec
export FastChargeAnalysisSpec, FastChargeAnalysis

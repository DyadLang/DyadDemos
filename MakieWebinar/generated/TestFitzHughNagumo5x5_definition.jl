...
@component function TestFitzHughNagumo5x5(; name = nothing, N=5, N_caps=25, N_h_res=20, N_v_res=20, N_boundary=20, kwargs...)
  ...
  r_horiz = System[]
  for i in 1:N_h_res
    push!(r_horiz, MakieWebinar.DiffusionResistor(D=ModelingToolkit.default_to_parentscope(5.0), dx=ModelingToolkit.default_to_parentscope(0.1), A=ModelingToolkit.default_to_parentscope(0.1), name=Symbol("r_horiz", "⸺", i), r_horiz_overrides...))
  end
  ...
  r_vert = System[]
  for i in 1:N_v_res
    push!(r_vert, MakieWebinar.DiffusionResistor(D=ModelingToolkit.default_to_parentscope(5.0), dx=ModelingToolkit.default_to_parentscope(0.1), A=ModelingToolkit.default_to_parentscope(0.1), name=Symbol("r_vert", "⸺", i), r_vert_overrides...))
  end

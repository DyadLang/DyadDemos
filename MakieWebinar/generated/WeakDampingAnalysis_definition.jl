...
@kwdef mutable struct WeakDampingAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :WeakDampingAnalysis
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestWeakDamping(; name=:TestWeakDamping)
end

function DyadInterface.run_analysis(spec::WeakDampingAnalysisSpec)
...
WeakDampingAnalysis(;kwargs...) = run_analysis(WeakDampingAnalysisSpec(;kwargs...))
export WeakDampingAnalysis, WeakDampingAnalysisSpec
export WeakDampingAnalysisSpec, WeakDampingAnalysis

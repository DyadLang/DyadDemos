...
@kwdef mutable struct TestFHNWaveTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestFHNWaveTransient
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 10
  var"abstol"::Float64 = 0.000001
  var"reltol"::Float64 = 0.000001
  var"saveat"::Float64 = 0.1
  var"dtmax"::Float64 = 0
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestFHNWave5x5(; name=:TestFHNWave5x5)
end

function DyadInterface.run_analysis(spec::TestFHNWaveTransientSpec)
...
TestFHNWaveTransient(;kwargs...) = run_analysis(TestFHNWaveTransientSpec(;kwargs...))
export TestFHNWaveTransient, TestFHNWaveTransientSpec
export TestFHNWaveTransientSpec, TestFHNWaveTransient

...
@kwdef mutable struct SlowChargeAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :SlowChargeAnalysis
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestSlowCharge(; name=:TestSlowCharge)
end

function DyadInterface.run_analysis(spec::SlowChargeAnalysisSpec)
...
SlowChargeAnalysis(;kwargs...) = run_analysis(SlowChargeAnalysisSpec(;kwargs...))
export SlowChargeAnalysis, SlowChargeAnalysisSpec
export SlowChargeAnalysisSpec, SlowChargeAnalysis

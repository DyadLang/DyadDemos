...
@kwdef mutable struct StrongDampingAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :StrongDampingAnalysis
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MakieWebinar.TestStrongDamping(; name=:TestStrongDamping)
end

function DyadInterface.run_analysis(spec::StrongDampingAnalysisSpec)
...
StrongDampingAnalysis(;kwargs...) = run_analysis(StrongDampingAnalysisSpec(;kwargs...))
export StrongDampingAnalysis, StrongDampingAnalysisSpec
export StrongDampingAnalysisSpec, StrongDampingAnalysis

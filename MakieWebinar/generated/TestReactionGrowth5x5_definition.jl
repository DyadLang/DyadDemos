...
@component function TestReactionGrowth5x5(; name = nothing, N=5, N_caps=25, N_h_res=20, N_v_res=20, N_bound=20, kwargs...)
  ...
  caps = System[]
  for i in 1:N_caps
    push!(caps, MakieWebinar.ReactionCapacitor(V=0.01, growth_rate=5, name=Symbol("caps", "⸺", i), caps_overrides...))
  end
  ...
  r_h = System[]
  for i in 1:N_h_res
    push!(r_h, MakieWebinar.DiffusionResistor(D=0.1, dx=0.1, A=0.1, name=Symbol("r_h", "⸺", i), r_h_overrides...))
  end
  ...
  r_v = System[]
  for i in 1:N_v_res
    push!(r_v, MakieWebinar.DiffusionResistor(D=0.1, dx=0.1, A=0.1, name=Symbol("r_v", "⸺", i), r_v_overrides...))
  end

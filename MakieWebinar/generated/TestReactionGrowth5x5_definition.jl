...
@component function TestReactionGrowth5x5(; name = nothing, N=5, N_caps=25, N_h_res=20, N_v_res=20, N_bound=20, kwargs...)
  ...
  caps = System[]
  for i in 1:N_caps
    push!(caps, MakieWebinar.ReactionCapacitor(V=ModelingToolkit.default_to_parentscope(0.01), growth_rate=ModelingToolkit.default_to_parentscope(5.0), name=Symbol("caps", "⸺", i), caps_overrides...))
  end

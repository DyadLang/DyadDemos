...
@kwdef mutable struct TestISO8608RoadTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestISO8608RoadTransient
  ...
  var"model"::Union{Nothing, System} = QuarterTruckSciML.TestISO8608Road(; name=:TestISO8608Road)
end

function DyadInterface.run_analysis(spec::TestISO8608RoadTransientSpec)
...
TestISO8608RoadTransient(;kwargs...) = run_analysis(TestISO8608RoadTransientSpec(;kwargs...))
export TestISO8608RoadTransient, TestISO8608RoadTransientSpec

...
include("HalfSineBump_definition.jl")
include("ISO8608Road_definition.jl")
include("Mux3_definition.jl")
include("Mux_definition.jl")
include("Mycomp_definition.jl")
include("NeuralNetworkBlock_definition.jl")
include("PureExternalForce_definition.jl")
include("QuarterTruckCalibrationAnalysis_definition.jl")
include("QuarterTruckConfigurable_definition.jl")
include("QuarterTruckFullNN1Analysis_definition.jl")
include("QuarterTruckFullNN1_definition.jl")
include("QuarterTruckFullNN_definition.jl")
include("RealExpression_definition.jl")
include("RealOutputArray_definition.jl")
include("ScaledNeuralNetworkBlock_definition.jl")
...
include("TestHalfSineBumpTransient_definition.jl")
include("TestHalfSineBump_definition.jl")
include("TestISO8608RoadTransient_definition.jl")
include("TestISO8608Road_definition.jl")
include("TestQuarterTruckConfigurableFullSin_definition.jl")
include("TestQuarterTruckFullNNISOA_definition.jl")
include("TestQuarterTruckFullNNSin_definition.jl")
include("TestQuarterTruckLinearISOA_definition.jl")
include("TestQuarterTruckNonlinearISOA_definition.jl")
include("TireWithExternalResidual_definition.jl")
include("TruckFullNNTrainingAnalysisLBFGS_definition.jl")
include("TruckFullNNTrainingAnalysis_definition.jl")
include("ViscoelasticSpringDamper_definition.jl")
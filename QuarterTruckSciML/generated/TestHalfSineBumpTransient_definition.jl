...
@kwdef mutable struct TestHalfSineBumpTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestHalfSineBumpTransient
  ...
  var"model"::Union{Nothing, System} = QuarterTruckSciML.TestHalfSineBump(; name=:TestHalfSineBump)
end

function DyadInterface.run_analysis(spec::TestHalfSineBumpTransientSpec)
...
TestHalfSineBumpTransient(;kwargs...) = run_analysis(TestHalfSineBumpTransientSpec(;kwargs...))
export TestHalfSineBumpTransient, TestHalfSineBumpTransientSpec

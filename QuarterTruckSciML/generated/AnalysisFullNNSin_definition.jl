...
@kwdef mutable struct AnalysisFullNNSinSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :AnalysisFullNNSin
...
function DyadInterface.run_analysis(spec::AnalysisFullNNSinSpec)
...
AnalysisFullNNSin(;kwargs...) = run_analysis(AnalysisFullNNSinSpec(;kwargs...))
export AnalysisFullNNSin, AnalysisFullNNSinSpec

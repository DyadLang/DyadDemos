...
@kwdef mutable struct TruckFullNNTrainingAnalysisLBFGSSpec <: AbstractNNTrainingAnalysisSpec
  ...
  var"optimizer"::DyadModelOptimizer.OptimizerAlg.Type = "LBFGS"
  var"optimizer_maxiters"::Int = 200
...
function DyadInterface.run_analysis(spec::TruckFullNNTrainingAnalysisLBFGSSpec)
...
TruckFullNNTrainingAnalysisLBFGS(;kwargs...) = run_analysis(TruckFullNNTrainingAnalysisLBFGSSpec(;kwargs...))
export TruckFullNNTrainingAnalysisLBFGS, TruckFullNNTrainingAnalysisLBFGSSpec

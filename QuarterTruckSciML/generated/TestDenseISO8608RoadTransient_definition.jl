...
@kwdef mutable struct TestDenseISO8608RoadTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestDenseISO8608RoadTransient
  ...
  var"model"::Union{Nothing, System} = QuarterTruckSciML.TestDenseISO8608Road(; name=:TestDenseISO8608Road)
end

function DyadInterface.run_analysis(spec::TestDenseISO8608RoadTransientSpec)
...
TestDenseISO8608RoadTransient(;kwargs...) = run_analysis(TestDenseISO8608RoadTransientSpec(;kwargs...))
export TestDenseISO8608RoadTransient, TestDenseISO8608RoadTransientSpec

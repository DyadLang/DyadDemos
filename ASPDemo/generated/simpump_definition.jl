...
@kwdef mutable struct simpumpSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simpump
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestPump(; name=:TestPump)
end

function DyadInterface.run_analysis(spec::simpumpSpec)
...
simpump(;kwargs...) = run_analysis(simpumpSpec(;kwargs...))
export simpump, simpumpSpec
export simpumpSpec, simpump

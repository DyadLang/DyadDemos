...
@kwdef mutable struct simmixer2Spec <: AbstractTransientAnalysisSpec
  name::Symbol = :simmixer2
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestMixer2(; name=:TestMixer2)
end

function DyadInterface.run_analysis(spec::simmixer2Spec)
...
simmixer2(;kwargs...) = run_analysis(simmixer2Spec(;kwargs...))
export simmixer2, simmixer2Spec
export simmixer2Spec, simmixer2

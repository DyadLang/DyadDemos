...
@kwdef mutable struct simclarifierbottomSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifierbottom
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifierBottom(; name=:TestClarifierBottom)
end

function DyadInterface.run_analysis(spec::simclarifierbottomSpec)
...
simclarifierbottom(;kwargs...) = run_analysis(simclarifierbottomSpec(;kwargs...))
export simclarifierbottom, simclarifierbottomSpec
export simclarifierbottomSpec, simclarifierbottom

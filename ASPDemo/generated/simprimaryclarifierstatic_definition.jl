...
@kwdef mutable struct simprimaryclarifierstaticSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simprimaryclarifierstatic
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestPrimaryClarifierStatic(; name=:TestPrimaryClarifierStatic)
end

function DyadInterface.run_analysis(spec::simprimaryclarifierstaticSpec)
...
simprimaryclarifierstatic(;kwargs...) = run_analysis(simprimaryclarifierstaticSpec(;kwargs...))
export simprimaryclarifierstatic, simprimaryclarifierstaticSpec
export simprimaryclarifierstaticSpec, simprimaryclarifierstatic

...
@kwdef mutable struct simsourcesinkSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simsourcesink
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestSourceSink(; name=:TestSourceSink)
end

function DyadInterface.run_analysis(spec::simsourcesinkSpec)
...
simsourcesink(;kwargs...) = run_analysis(simsourcesinkSpec(;kwargs...))
export simsourcesink, simsourcesinkSpec
export simsourcesinkSpec, simsourcesink

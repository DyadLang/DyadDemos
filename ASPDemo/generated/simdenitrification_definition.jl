...
@kwdef mutable struct simdenitrificationSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simdenitrification
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestDenitrification(; name=:TestDenitrification)
end

function DyadInterface.run_analysis(spec::simdenitrificationSpec)
...
simdenitrification(;kwargs...) = run_analysis(simdenitrificationSpec(;kwargs...))
export simdenitrification, simdenitrificationSpec
export simdenitrificationSpec, simdenitrification

...
@kwdef mutable struct simbenchplantSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simbenchplant
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.BenchPlant(; name=:BenchPlant)
end

function DyadInterface.run_analysis(spec::simbenchplantSpec)
...
simbenchplant(;kwargs...) = run_analysis(simbenchplantSpec(;kwargs...))
export simbenchplant, simbenchplantSpec
export simbenchplantSpec, simbenchplant

...
@doc Markdown.doc"""
   TestPrimaryClarifierStatic(; name)
"""
@component function TestPrimaryClarifierStatic(; name = nothing, kwargs...)
  isnothing(name) && throw(ArgumentError("""
        The `name` keyword must be provided. Please consider using the `@named` macro,
        like so:

        @named model = TestPrimaryClarifierStatic()
        """))
...
export TestPrimaryClarifierStatic

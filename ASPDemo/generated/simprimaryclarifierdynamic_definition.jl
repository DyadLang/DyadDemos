...
@kwdef mutable struct simprimaryclarifierdynamicSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simprimaryclarifierdynamic
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestPrimaryClarifierDynamic(; name=:TestPrimaryClarifierDynamic)
end

function DyadInterface.run_analysis(spec::simprimaryclarifierdynamicSpec)
...
simprimaryclarifierdynamic(;kwargs...) = run_analysis(simprimaryclarifierdynamicSpec(;kwargs...))
export simprimaryclarifierdynamic, simprimaryclarifierdynamicSpec
export simprimaryclarifierdynamicSpec, simprimaryclarifierdynamic

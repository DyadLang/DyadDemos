...
@kwdef mutable struct simflowsourcefileesinkSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simflowsourcefileesink
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestFlowSourceFileSink(; name=:TestFlowSourceFileSink)
end

function DyadInterface.run_analysis(spec::simflowsourcefileesinkSpec)
...
simflowsourcefileesink(;kwargs...) = run_analysis(simflowsourcefileesinkSpec(;kwargs...))
export simflowsourcefileesink, simflowsourcefileesinkSpec
export simflowsourcefileesinkSpec, simflowsourcefileesink

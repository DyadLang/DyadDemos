...
| `Q2`         |                          | --  | 
"""
@component function TestDivider2(; name = nothing)
  isnothing(name) && throw(ArgumentError("""
        The `name` keyword must be provided. Please consider using the `@named` macro,
        like so:

        @named model = TestDivider2()
        """))
  ...
  push!(__eqs, connect(divider.portOut2, pump.portIn))
  push!(__eqs, connect(pump.portOut, sink2.port))

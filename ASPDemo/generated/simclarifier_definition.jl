...
@kwdef mutable struct simclarifierSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifier
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifier(; name=:TestClarifier)
end

function DyadInterface.run_analysis(spec::simclarifierSpec)
...
simclarifier(;kwargs...) = run_analysis(simclarifierSpec(;kwargs...))
export simclarifier, simclarifierSpec
export simclarifierSpec, simclarifier

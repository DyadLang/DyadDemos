...
@kwdef mutable struct simcontrolleddivider2Spec <: AbstractTransientAnalysisSpec
  name::Symbol = :simcontrolleddivider2
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 2.5
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestControlledDivider2(; name=:TestControlledDivider2)
end

function DyadInterface.run_analysis(spec::simcontrolleddivider2Spec)
...
simcontrolleddivider2(;kwargs...) = run_analysis(simcontrolleddivider2Spec(;kwargs...))
export simcontrolleddivider2, simcontrolleddivider2Spec
export simcontrolleddivider2Spec, simcontrolleddivider2

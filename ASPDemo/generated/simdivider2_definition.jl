...
@kwdef mutable struct simdivider2Spec <: AbstractTransientAnalysisSpec
  name::Symbol = :simdivider2
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestDivider2(; name=:TestDivider2)
end

function DyadInterface.run_analysis(spec::simdivider2Spec)
...
simdivider2(;kwargs...) = run_analysis(simdivider2Spec(;kwargs...))
export simdivider2, simdivider2Spec
export simdivider2Spec, simdivider2

...
@kwdef mutable struct simflowsourcesinkSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simflowsourcesink
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestFlowSourceSink(; name=:TestFlowSourceSink)
end

function DyadInterface.run_analysis(spec::simflowsourcesinkSpec)
...
simflowsourcesink(;kwargs...) = run_analysis(simflowsourcesinkSpec(;kwargs...))
export simflowsourcesink, simflowsourcesinkSpec
export simflowsourcesinkSpec, simflowsourcesink

...
@kwdef mutable struct simcombinedsensorSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simcombinedsensor
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 4.5
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestCombinedSensor(; name=:TestCombinedSensor)
end

function DyadInterface.run_analysis(spec::simcombinedsensorSpec)
...
simcombinedsensor(;kwargs...) = run_analysis(simcombinedsensorSpec(;kwargs...))
export simcombinedsensor, simcombinedsensorSpec
export simcombinedsensorSpec, simcombinedsensor

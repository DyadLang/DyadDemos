...
@kwdef mutable struct simclarifierfeedSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifierfeed
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifierFeed(; name=:TestClarifierFeed)
end

function DyadInterface.run_analysis(spec::simclarifierfeedSpec)
...
simclarifierfeed(;kwargs...) = run_analysis(simclarifierfeedSpec(;kwargs...))
export simclarifierfeed, simclarifierfeedSpec
export simclarifierfeedSpec, simclarifierfeed

...
@kwdef mutable struct simblowerSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simblower
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestBlower(; name=:TestBlower)
end

function DyadInterface.run_analysis(spec::simblowerSpec)
...
simblower(;kwargs...) = run_analysis(simblowerSpec(;kwargs...))
export simblower, simblowerSpec
export simblowerSpec, simblower

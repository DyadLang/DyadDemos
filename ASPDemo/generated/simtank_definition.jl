...
@kwdef mutable struct simtankSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simtank
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestTank(; name=:TestTank)
end

function DyadInterface.run_analysis(spec::simtankSpec)
...
simtank(;kwargs...) = run_analysis(simtankSpec(;kwargs...))
export simtank, simtankSpec
export simtankSpec, simtank

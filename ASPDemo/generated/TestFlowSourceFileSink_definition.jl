...
@doc Markdown.doc"""
   TestFlowSourceFileSink(; name)
"""
@component function TestFlowSourceFileSink(; name = nothing, kwargs...)
  isnothing(name) && throw(ArgumentError("""
        The `name` keyword must be provided. Please consider using the `@named` macro,
        like so:

        @named model = TestFlowSourceFileSink()
        """))
  ...
  push!(__systems, @named source = ASPDemo.FlowSourceFile(source_overrides...))

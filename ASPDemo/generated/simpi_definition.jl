...
@kwdef mutable struct simpiSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simpi
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestPI(; name=:TestPI)
end

function DyadInterface.run_analysis(spec::simpiSpec)
...
simpi(;kwargs...) = run_analysis(simpiSpec(;kwargs...))
export simpi, simpiSpec
export simpiSpec, simpi

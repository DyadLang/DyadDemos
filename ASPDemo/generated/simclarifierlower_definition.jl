...
@kwdef mutable struct simclarifierlowerSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifierlower
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifierLower(; name=:TestClarifierLower)
end

function DyadInterface.run_analysis(spec::simclarifierlowerSpec)
...
simclarifierlower(;kwargs...) = run_analysis(simclarifierlowerSpec(;kwargs...))
export simclarifierlower, simclarifierlowerSpec
export simclarifierlowerSpec, simclarifierlower

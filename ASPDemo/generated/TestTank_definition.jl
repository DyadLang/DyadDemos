...
@doc Markdown.doc"""
   TestTank(; name)
"""
@component function TestTank(; name = nothing, kwargs...)
  isnothing(name) && throw(ArgumentError("""
        The `name` keyword must be provided. Please consider using the `@named` macro,
        like so:

        @named model = TestTank()
        """))
  ...
  # Subcomponent tank of type ASPDemo.PartialTank_2Port
  ...
  push!(__systems, @named tank = ASPDemo.PartialTank_2Port(tank_overrides...))

...
@kwdef mutable struct simclarifierupperSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifierupper
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifierUpper(; name=:TestClarifierUpper)
end

function DyadInterface.run_analysis(spec::simclarifierupperSpec)
...
simclarifierupper(;kwargs...) = run_analysis(simclarifierupperSpec(;kwargs...))
export simclarifierupper, simclarifierupperSpec
export simclarifierupperSpec, simclarifierupper

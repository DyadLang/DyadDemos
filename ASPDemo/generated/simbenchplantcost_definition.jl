...
@kwdef mutable struct simbenchplantcostSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simbenchplantcost
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.BenchPlantCOST(; name=:BenchPlantCOST)
end

function DyadInterface.run_analysis(spec::simbenchplantcostSpec)
...
simbenchplantcost(;kwargs...) = run_analysis(simbenchplantcostSpec(;kwargs...))
export simbenchplantcost, simbenchplantcostSpec
export simbenchplantcostSpec, simbenchplantcost

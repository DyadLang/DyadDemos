...
@kwdef mutable struct simclarifiertopSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simclarifiertop
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestClarifierTop(; name=:TestClarifierTop)
end

function DyadInterface.run_analysis(spec::simclarifiertopSpec)
...
simclarifiertop(;kwargs...) = run_analysis(simclarifiertopSpec(;kwargs...))
export simclarifiertop, simclarifiertopSpec
export simclarifiertopSpec, simclarifiertop

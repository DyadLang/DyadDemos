...
@kwdef mutable struct simnitrificationSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :simnitrification
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = ASPDemo.TestNitrification(; name=:TestNitrification)
end

function DyadInterface.run_analysis(spec::simnitrificationSpec)
...
simnitrification(;kwargs...) = run_analysis(simnitrificationSpec(;kwargs...))
export simnitrification, simnitrificationSpec
export simnitrificationSpec, simnitrification

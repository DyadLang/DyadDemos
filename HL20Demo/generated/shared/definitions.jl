...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "shared", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "shared", "definitions.jl"))
end
...
include("HL20Aero_definition.jl")
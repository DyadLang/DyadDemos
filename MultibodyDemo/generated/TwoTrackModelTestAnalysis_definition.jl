...
@kwdef mutable struct TwoTrackModelTestAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TwoTrackModelTestAnalysis
  ...
  var"model"::Union{Nothing, System} = MultibodyDemo.TwoTrackModelTest(; name=:TwoTrackModelTest)
end

function DyadInterface.run_analysis(spec::TwoTrackModelTestAnalysisSpec)
...
TwoTrackModelTestAnalysis(;kwargs...) = run_analysis(TwoTrackModelTestAnalysisSpec(;kwargs...))
export TwoTrackModelTestAnalysis, TwoTrackModelTestAnalysisSpec

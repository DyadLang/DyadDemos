...
@kwdef mutable struct PendulumTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :PendulumTransient
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 3.0
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = MultibodyDemo.Pendulum(; name=:Pendulum)
end

function DyadInterface.run_analysis(spec::PendulumTransientSpec)
...
PendulumTransient(;kwargs...) = run_analysis(PendulumTransientSpec(;kwargs...))
export PendulumTransient, PendulumTransientSpec

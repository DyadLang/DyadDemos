...
@kwdef mutable struct SpringDamperSystemTestAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :SpringDamperSystemTestAnalysis
  ...
  var"model"::Union{Nothing, System} = MultibodyDemo.SpringDamperSystemTest(; name=:SpringDamperSystemTest)
end

function DyadInterface.run_analysis(spec::SpringDamperSystemTestAnalysisSpec)
...
SpringDamperSystemTestAnalysis(;kwargs...) = run_analysis(SpringDamperSystemTestAnalysisSpec(;kwargs...))
export SpringDamperSystemTestAnalysis, SpringDamperSystemTestAnalysisSpec

...
@kwdef mutable struct DyadBalans2DAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :DyadBalans2DAnalysis
  ...
  var"model"::Union{Nothing, System} = MultibodyDemo.DyadBalans2D(; name=:DyadBalans2D)
end

function DyadInterface.run_analysis(spec::DyadBalans2DAnalysisSpec)
...
DyadBalans2DAnalysis(;kwargs...) = run_analysis(DyadBalans2DAnalysisSpec(;kwargs...))
export DyadBalans2DAnalysis, DyadBalans2DAnalysisSpec

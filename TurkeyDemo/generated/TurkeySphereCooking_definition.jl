...
function DyadInterface.run_analysis(spec::TurkeySphereCookingSpec)
...
TurkeySphereCooking(;kwargs...) = run_analysis(TurkeySphereCookingSpec(;kwargs...))
export TurkeySphereCooking, TurkeySphereCookingSpec
export TurkeySphereCookingSpec, TurkeySphereCooking

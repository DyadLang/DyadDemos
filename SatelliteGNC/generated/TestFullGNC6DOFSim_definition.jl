...
@kwdef mutable struct TestFullGNC6DOFSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestFullGNC6DOFSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestFullGNC6DOF(; name=:TestFullGNC6DOF)
end

function DyadInterface.run_analysis(spec::TestFullGNC6DOFSimSpec)
...
TestFullGNC6DOFSim(;kwargs...) = run_analysis(TestFullGNC6DOFSimSpec(;kwargs...))
export TestFullGNC6DOFSim, TestFullGNC6DOFSimSpec
export TestFullGNC6DOFSimSpec, TestFullGNC6DOFSim

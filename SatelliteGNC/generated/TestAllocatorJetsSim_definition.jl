...
@kwdef mutable struct TestAllocatorJetsSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestAllocatorJetsSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestAllocatorJets(; name=:TestAllocatorJets)
end

function DyadInterface.run_analysis(spec::TestAllocatorJetsSimSpec)
...
TestAllocatorJetsSim(;kwargs...) = run_analysis(TestAllocatorJetsSimSpec(;kwargs...))
export TestAllocatorJetsSim, TestAllocatorJetsSimSpec
export TestAllocatorJetsSimSpec, TestAllocatorJetsSim

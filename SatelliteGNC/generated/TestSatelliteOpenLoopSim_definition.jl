...
@kwdef mutable struct TestSatelliteOpenLoopSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestSatelliteOpenLoopSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestSatelliteOpenLoop(; name=:TestSatelliteOpenLoop)
end

function DyadInterface.run_analysis(spec::TestSatelliteOpenLoopSimSpec)
...
TestSatelliteOpenLoopSim(;kwargs...) = run_analysis(TestSatelliteOpenLoopSimSpec(;kwargs...))
export TestSatelliteOpenLoopSim, TestSatelliteOpenLoopSimSpec
export TestSatelliteOpenLoopSimSpec, TestSatelliteOpenLoopSim

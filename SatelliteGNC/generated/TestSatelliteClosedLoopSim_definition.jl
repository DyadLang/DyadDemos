...
@kwdef mutable struct TestSatelliteClosedLoopSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestSatelliteClosedLoopSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestSatelliteClosedLoop(; name=:TestSatelliteClosedLoop)
end

function DyadInterface.run_analysis(spec::TestSatelliteClosedLoopSimSpec)
...
TestSatelliteClosedLoopSim(;kwargs...) = run_analysis(TestSatelliteClosedLoopSimSpec(;kwargs...))
export TestSatelliteClosedLoopSim, TestSatelliteClosedLoopSimSpec
export TestSatelliteClosedLoopSimSpec, TestSatelliteClosedLoopSim

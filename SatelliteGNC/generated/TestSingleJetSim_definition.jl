...
@kwdef mutable struct TestSingleJetSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestSingleJetSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestSingleJet(; name=:TestSingleJet)
end

function DyadInterface.run_analysis(spec::TestSingleJetSimSpec)
...
TestSingleJetSim(;kwargs...) = run_analysis(TestSingleJetSimSpec(;kwargs...))
export TestSingleJetSim, TestSingleJetSimSpec
export TestSingleJetSimSpec, TestSingleJetSim

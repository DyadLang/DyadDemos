...
@kwdef mutable struct TestFullGNCSimSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestFullGNCSim
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = SatelliteGNC.TestFullGNC(; name=:TestFullGNC)
end

function DyadInterface.run_analysis(spec::TestFullGNCSimSpec)
...
TestFullGNCSim(;kwargs...) = run_analysis(TestFullGNCSimSpec(;kwargs...))
export TestFullGNCSim, TestFullGNCSimSpec
export TestFullGNCSimSpec, TestFullGNCSim

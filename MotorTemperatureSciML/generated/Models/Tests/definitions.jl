...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname |> Base.dirname, "dyad", "Models", "Tests", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname |> Base.dirname, "dyad", "Models", "Tests", "definitions.jl"))
end
...
include("TestTNNModelAnalysis_definition.jl")
include("TestTNNModel_definition.jl")
include("TestTNNProfileAnalysis_definition.jl")
include("TestTNNProfile_definition.jl")
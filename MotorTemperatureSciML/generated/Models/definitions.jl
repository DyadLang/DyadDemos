...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Models", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Models", "definitions.jl"))
end
...
include("TNNModel_definition.jl")
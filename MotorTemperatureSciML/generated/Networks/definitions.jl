...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Networks", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Networks", "definitions.jl"))
end
...
include("ConductanceNet_definition.jl")
include("PowerLossNet_definition.jl")
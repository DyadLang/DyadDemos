...
@kwdef mutable struct TestPowerLossNetAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestPowerLossNetAnalysis
  ...
  # analysis solves.
  var"model"::Union{Nothing, System} = MotorTemperatureSciML.Networks.Tests.TestPowerLossNet(; name=:TestPowerLossNet)
end

function DyadInterface.run_analysis(spec::TestPowerLossNetAnalysisSpec)
...
TestPowerLossNetAnalysis(;kwargs...) = run_analysis(TestPowerLossNetAnalysisSpec(;kwargs...))
export TestPowerLossNetAnalysis, TestPowerLossNetAnalysisSpec

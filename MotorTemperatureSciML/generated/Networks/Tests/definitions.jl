...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname |> Base.dirname, "dyad", "Networks", "Tests", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname |> Base.dirname, "dyad", "Networks", "Tests", "definitions.jl"))
end
...
include("TestConductanceNetAnalysis_definition.jl")
include("TestConductanceNet_definition.jl")
include("TestPowerLossNetAnalysis_definition.jl")
include("TestPowerLossNet_definition.jl")
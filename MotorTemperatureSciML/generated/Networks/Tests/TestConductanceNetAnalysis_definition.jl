...
@kwdef mutable struct TestConductanceNetAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestConductanceNetAnalysis
  ...
  # analysis solves.
  var"model"::Union{Nothing, System} = MotorTemperatureSciML.Networks.Tests.TestConductanceNet(; name=:TestConductanceNet)
end

function DyadInterface.run_analysis(spec::TestConductanceNetAnalysisSpec)
...
TestConductanceNetAnalysis(;kwargs...) = run_analysis(TestConductanceNetAnalysisSpec(;kwargs...))
export TestConductanceNetAnalysis, TestConductanceNetAnalysisSpec

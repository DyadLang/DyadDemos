...
@kwdef mutable struct TestDrivelineChirpMaxwellOnlyTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestDrivelineChirpMaxwellOnlyTransient
  ...
  var"model"::Union{Nothing, System} = DrivelineSciML.TestDrivelineChirpMaxwellOnly(; name=:TestDrivelineChirpMaxwellOnly)
end

function DyadInterface.run_analysis(spec::TestDrivelineChirpMaxwellOnlyTransientSpec)
...
TestDrivelineChirpMaxwellOnlyTransient(;kwargs...) = run_analysis(TestDrivelineChirpMaxwellOnlyTransientSpec(;kwargs...))
export TestDrivelineChirpMaxwellOnlyTransient, TestDrivelineChirpMaxwellOnlyTransientSpec

...
@kwdef mutable struct TestDrivelineTipInTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestDrivelineTipInTransient
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 2.0
  var"abstol"::Float64 = 0.000001
  var"reltol"::Float64 = 0.000001
  var"saveat"::Float64 = 0.0005
  var"dtmax"::Float64 = 0
  ...
  var"model"::Union{Nothing, System} = DrivelineSciML.TestDrivelineTipIn(; name=:TestDrivelineTipIn)
end

function DyadInterface.run_analysis(spec::TestDrivelineTipInTransientSpec)
...
TestDrivelineTipInTransient(;kwargs...) = run_analysis(TestDrivelineTipInTransientSpec(;kwargs...))
export TestDrivelineTipInTransient, TestDrivelineTipInTransientSpec

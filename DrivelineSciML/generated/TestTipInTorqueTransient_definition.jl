...
@kwdef mutable struct TestTipInTorqueTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestTipInTorqueTransient
  ...
  var"model"::Union{Nothing, System} = DrivelineSciML.TestTipInTorque(; name=:TestTipInTorque)
end

function DyadInterface.run_analysis(spec::TestTipInTorqueTransientSpec)
...
TestTipInTorqueTransient(;kwargs...) = run_analysis(TestTipInTorqueTransientSpec(;kwargs...))
export TestTipInTorqueTransient, TestTipInTorqueTransientSpec

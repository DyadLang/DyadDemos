...
@kwdef mutable struct TestDrivelineChirpTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestDrivelineChirpTransient
...
function DyadInterface.run_analysis(spec::TestDrivelineChirpTransientSpec)
...
TestDrivelineChirpTransient(;kwargs...) = run_analysis(TestDrivelineChirpTransientSpec(;kwargs...))
export TestDrivelineChirpTransient, TestDrivelineChirpTransientSpec

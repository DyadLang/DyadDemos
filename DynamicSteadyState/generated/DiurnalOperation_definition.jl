...
@kwdef mutable struct DiurnalOperationSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :DiurnalOperation
  ...
  var"log_file"::String = ""
  var"model"::Union{Nothing, System} = DynamicSteadyState.TestDiurnalOperation(; name=:TestDiurnalOperation)
end

function DyadInterface.run_analysis(spec::DiurnalOperationSpec)
...
DiurnalOperation(;kwargs...) = run_analysis(DiurnalOperationSpec(;kwargs...))
export DiurnalOperation, DiurnalOperationSpec
export DiurnalOperationSpec, DiurnalOperation

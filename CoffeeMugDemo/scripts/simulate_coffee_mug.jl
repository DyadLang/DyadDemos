...
res = @time TransientAnalysis(; model, alg = ODEAlg.Auto(), abstol = 10.0e-3, reltol = 1.0e-3, start = 0.0, stop = 6000)
...
res2 = @time TransientAnalysis(; model=model2, alg = ODEAlg.Auto(), abstol = 10.0e-3, reltol = 1.0e-3, start = 0.0, stop = 6000)

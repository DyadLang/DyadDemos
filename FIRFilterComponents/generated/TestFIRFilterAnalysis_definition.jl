...
@kwdef mutable struct TestFIRFilterAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TestFIRFilterAnalysis
  var"alg"::ODEAlg.Type = ODEAlg.Auto()
  var"start"::Float64 = 0
  var"stop"::Float64 = 2 * pi
  ...
  var"model"::Union{Nothing, System} = FIRFilterComponents.TestFIRFilter(; name=:TestFIRFilter)
end

function DyadInterface.run_analysis(spec::TestFIRFilterAnalysisSpec)
...
TestFIRFilterAnalysis(;kwargs...) = run_analysis(TestFIRFilterAnalysisSpec(;kwargs...))
export TestFIRFilterAnalysis, TestFIRFilterAnalysisSpec

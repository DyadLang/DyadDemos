...
@testset "Running test case1 for FrictionBrakeDemo.SimpleVehicleTest_Constant" begin
  using CSV, DataFrames, Plots
  using DyadInterface: TransientAnalysis, rebuild_sol, ODEAlg
  using ModelingToolkit: toggle_namespacing, get_initial_conditions, @named

  @named model = FrictionBrakeDemo.SimpleVehicleTest_Constant()
  ...
  @test sol[model.vehicle.vehicle_speed][end] ≈ 40.218 atol=0.001 rtol=9.999999999999999e-6
# Signals selected for regression testing: ["vehicle.vehicle_speed","vehicle.wheel_speed","vehicle.inertia.w"]
  ...
  if get(ENV, "DYAD_UPDATE_REFS", "") !== ""
    ...
    mkpath("snapshots")
    CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig0.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.vehicle_speed) for t in ref_times]))
    CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig1.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.wheel_speed) for t in ref_times]))
    CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig2.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.inertia.w) for t in ref_times]))
  end
    if isfile("snapshots/SimpleVehicleTest_Constant_case1_sig0.ref")
      ...
      if get(ENV, "DYAD_COMPARISONS", "") !== ""
        ...
        plot!([df.t[end]], [40.218], seriestype=:scatter, label="Final Condition for vehicle.vehicle_speed")
        mkpath("comparisons")
        savefig("comparisons/SimpleVehicleTest_Constant_case1_sig0.png")
      end
    else
      mkpath("snapshots")
      CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig0.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.vehicle_speed) for t in ref_times]))
    ...
    if isfile("snapshots/SimpleVehicleTest_Constant_case1_sig1.ref")
      ...
      if get(ENV, "DYAD_COMPARISONS", "") !== ""
        ...
        mkpath("comparisons")
        savefig("comparisons/SimpleVehicleTest_Constant_case1_sig1.png")
      end
    else
      mkpath("snapshots")
      CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig1.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.wheel_speed) for t in ref_times]))
    ...
    if isfile("snapshots/SimpleVehicleTest_Constant_case1_sig2.ref")
      ...
      if get(ENV, "DYAD_COMPARISONS", "") !== ""
        ...
        mkpath("comparisons")
        savefig("comparisons/SimpleVehicleTest_Constant_case1_sig2.png")
      end
    else
      mkpath("snapshots")
      CSV.write("snapshots/SimpleVehicleTest_Constant_case1_sig2.ref", DataFrame(t=ref_times, expected=[sol(t, idxs=model.vehicle.inertia.w) for t in ref_times]))

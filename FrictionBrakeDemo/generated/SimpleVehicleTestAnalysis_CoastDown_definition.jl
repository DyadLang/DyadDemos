...
function DyadInterface.run_analysis(spec::SimpleVehicleTestAnalysis_CoastDownSpec)
...
SimpleVehicleTestAnalysis_CoastDown(;kwargs...) = run_analysis(SimpleVehicleTestAnalysis_CoastDownSpec(;kwargs...))
export SimpleVehicleTestAnalysis_CoastDown, SimpleVehicleTestAnalysis_CoastDownSpec
export SimpleVehicleTestAnalysis_CoastDownSpec, SimpleVehicleTestAnalysis_CoastDown

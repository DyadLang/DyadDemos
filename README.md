...
| <img src="./HVACDemo/assets/image.png" width="48"/> | [**HVACDemo**](./HVACDemo/) | A vapor-compression refrigeration cycle modeling a complete HVAC cycle with a refrigerant loop (R32) exchanging heat with two moist-air streams. |
